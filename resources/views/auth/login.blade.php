...
<body class="bg-zinc-950 text-zinc-100 min-h-full flex items-center justify-center p-4 relative overflow-x-hidden selection:bg-indigo-500 selection:text-white">
    ...
    <div class="fixed bottom-10 right-10 w-96 h-96 bg-purple-600/10 rounded-full blur-3xl pointer-events-none -z-10"></div>
    ...
    <div class="w-full max-w-md my-8">
        ...
        <div class="text-center mb-8">
            ...
            <h1 class="text-2xl font-bold text-white tracking-tight mt-2">Selamat Datang Kembali</h1>
            <p class="text-zinc-400 text-xs mt-1">Masuk untuk menikmati musik favorit dan bergabung di Room</p>
        </div>
        ...
        <div class="bg-zinc-900/80 backdrop-blur-2xl border border-zinc-800/80 rounded-3xl p-8 shadow-2xl space-y-6">
            ...
            @if(session('success'))
            <div class="p-3.5 rounded-2xl bg-emerald-500/15 border border-emerald-500/30 text-emerald-300 text-xs font-semibold flex items-center gap-2.5">
                <span>✅</span>
            ...
            @if(session('info'))
            <div class="p-3.5 rounded-2xl bg-indigo-500/15 border border-indigo-500/30 text-indigo-300 text-xs font-semibold flex items-center gap-2.5">
                <span>ℹ️</span>
            ...
            <div class="relative flex items-center justify-center">
                ...
                <span class="bg-zinc-900 px-3 text-[11px] font-semibold text-zinc-500 uppercase tracking-wider relative">atau dengan email</span>
            </div>
            ...
            <form action="{{ route('login.post') }}" method="POST" class="space-y-4">
                ...
                <div class="space-y-1.5">
                    <div class="flex items-center justify-between">
                        <label for="password" class="block text-xs font-semibold text-zinc-300">Kata Sandi</label>
                    </div>
                    <div class="relative">
                ...
                <div class="flex items-center justify-between pt-1">
                    <label class="flex items-center gap-2 cursor-pointer select-none">
                        <input type="checkbox" name="remember" class="w-4 h-4 rounded border-zinc-700 bg-zinc-950 text-indigo-600 focus:ring-indigo-500 accent-indigo-600 cursor-pointer">
                ...
                <!-- SUBMIT BUTTON -->
                <button type="submit" 
                        class="w-full py-3.5 px-4 rounded-2xl bg-indigo-600 hover:bg-indigo-500 text-white font-bold text-xs transition-all duration-200 shadow-lg shadow-indigo-600/30 flex items-center justify-center gap-2 hover:scale-[1.01] active:scale-95">
        ...
        <div class="text-center mt-6 space-y-2">
            <p class="text-xs text-zinc-400">
                Belum punya akun? 
                <a href="{{ route('register') }}" class="font-bold text-indigo-400 hover:text-indigo-300 transition underline underline-offset-4">
